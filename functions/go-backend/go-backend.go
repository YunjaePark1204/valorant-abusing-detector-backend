package main
    ...
    import (
    	...
    	ginCors "[github.com/gin-contrib/cors](https://github.com/gin-contrib/cors)"
    	...
    	ginadapter "[github.com/awslabs/aws-lambda-go-api-proxy/gin](https://github.com/awslabs/aws-lambda-go-api-proxy/gin)"
    ...
    func init() {
    	...
    	corsConfig.AllowOrigins = []string{
    		...
    		"[https://valorant-abusing-frontend-nl2zoffma-park-yunjaes-projects.vercel.app](https://valorant-abusing-frontend-nl2zoffma-park-yunjaes-projects.vercel.app)", // **여기에 당신의 Vercel 프론트엔드 URL을 정확히 입력하세요!**
    	}
    	...
    	r.GET("/account/riotid", func(c *gin.Context) {
    		...
    		url := "[https://asia.api.riotgames.com/riot/account/v1/accounts/by-riot-id/](https://asia.api.riotgames.com/riot/account/v1/accounts/by-riot-id/)" + gameName + "/" + tagLine
